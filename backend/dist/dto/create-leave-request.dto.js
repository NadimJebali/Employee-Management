...
__decorate([
    (0, swagger_1.ApiProperty)({ example: '2025-05-15' }),
    (0, class_validator_1.IsDateString)(),
    (0, class_validator_1.IsNotEmpty)(),
    __metadata("design:type", String)
], CreateLeaveRequestDto.prototype, "endDate", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'Family trip to Armageddon' }),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsNotEmpty)(),
    __metadata("design:type", String)
], CreateLeaveRequestDto.prototype, "reason", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ enum: leaveStatus_enum_1.LeaveStatus, default: leaveStatus_enum_1.LeaveStatus.PENDING }),
    (0, class_validator_1.IsEnum)(leaveStatus_enum_1.LeaveStatus),
    __metadata("design:type", String)
], CreateLeaveRequestDto.prototype, "status", void 0);
__decorate([
...
__decorate([
    ...
    (0, class_validator_1.IsEnum)(leaveType_enum_1.LeaveType),
    (0, class_validator_1.IsNotEmpty)(),
    __metadata("design:type", String)
