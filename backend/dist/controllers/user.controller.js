...
let UserController = class UserController {
    ...
    getEmployeeEvaluation(id) {
        return this.userService.getUserEvaluation(+id);
    }
    getEmployeeTimesheet(id) {
...
__decorate([
    ...
    (0, common_1.Get)('leave-requests/:id'),
    (0, swagger_1.ApiOperation)({ summary: 'Get all leave request by user id' }),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], UserController.prototype, "getEmployeeLeaveRequests", null);
__decorate([
    (0, role_decorator_1.Roles)(roles_enum_1.Role.HR, roles_enum_1.Role.ADMIN, roles_enum_1.Role.EMPLOYEE),
    (0, common_1.Get)('evaluation/:id'),
    (0, swagger_1.ApiOperation)({ summary: 'Get all Evaluation by user id' }),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], UserController.prototype, "getEmployeeEvaluation", null);
__decorate([
    (0, role_decorator_1.Roles)(roles_enum_1.Role.HR, roles_enum_1.Role.ADMIN, roles_enum_1.Role.EMPLOYEE),
    (0, common_1.Get)('timesheet/:id'),
    (0, swagger_1.ApiOperation)({ summary: 'Get all Evaluation by user id' }),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], UserController.prototype, "getEmployeeTimesheet", null);
